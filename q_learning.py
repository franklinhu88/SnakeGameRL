...
def train(
    ...
    for ep in range(1, n_episodes + 1):
        ...
        if ep % log_every == 0:
            ...
            print(f"Q-Learning Episode {ep}/{n_episodes} | avg_reward={avg_recent:.2f} | epsilon={epsilon:.4f}")
    ...
    # SAVE TRAINING CURVE
    # --------------------------------
    np.save("q_rewards.npy", episode_rewards)
    print("Saved Q-learning reward curve to q_rewards.npy")
...
def evaluate(env: SnakeEnv, Q, n_episodes=10, render=True, max_steps_per_episode=2000, seed=None):
    ...
    for ep in range(n_episodes):
        ...
        print(f"Q-Learning Eval {ep+1}: score={scores[-1]}, steps={steps}, reward={total_reward:.2f}")
